...
export const fallbackModels = [
  ...
  { id: 'Qwen3-Coder-Next-FP8', provider: 'Alibaba', type: 'Code', context: '128k', input: 5, output: 5, status: 'Live' },
  { id: 'Qwen3.5-397B-A17B', provider: 'Alibaba', type: 'Reasoning', context: '128k', input: 0.48, output: 2.88, status: 'Live' },
  { id: 'Qwen3.6-35B-A3B', provider: 'Alibaba', type: 'Text', context: '128k', input: 0.15, output: 1, status: 'Live' },
  { id: 'sensenova-6.7-flash-lite', provider: 'SenseTime', type: 'Text', context: '128k', input: 2, output: 2, status: 'Live' },
