...
export const fallbackModels = [
  ...
  { id: 'minimaxai/minimax-m2.7', provider: 'MiniMax', type: 'Text', context: '128k', input: 0.3, output: 1.2, status: 'Live' },
  { id: 'mistralai/mistral-small-4-119b-2603', provider: 'Mistral', type: 'Text', context: '32k', input: 0.2, output: 0.6, status: 'Live' },
  { id: 'mistralai/mistral-nemotron', provider: 'NVIDIA', type: 'Code', context: '128k', input: 0.15, output: 0.45, status: 'Live' },
  { id: 'meta/llama-4-maverick-17b-128e-instruct', provider: 'Meta', type: 'Text', context: '128k', input: 0.1, output: 0.3, status: 'Live' },
  { id: 'meta/llama-3.1-70b-instruct', provider: 'Meta', type: 'Text', context: '128k', input: 0.35, output: 0.4, status: 'Live' },
  { id: 'meta/llama-3.2-11b-vision-instruct', provider: 'Meta', type: 'Image', context: '128k', input: 0.1, output: 0.3, status: 'Live' },
  { id: 'qwen/qwen3-next-80b-a3b-instruct', provider: 'Alibaba', type: 'Text', context: '32k', input: 0.3, output: 0.8, status: 'Live' },
  { id: 'nvidia/nemotron-3-super-120b-a12b', provider: 'NVIDIA', type: 'Text', context: '4k', input: 0.5, output: 1.5, status: 'Live' },
  { id: 'nvidia/nemotron-3-nano-omni-30b-a3b-reasoning', provider: 'NVIDIA', type: 'Reasoning', context: '4k', input: 0.2, output: 0.8, status: 'Live' },
  { id: 'nvidia/nvidia-nemotron-nano-9b-v2', provider: 'NVIDIA', type: 'Text', context: '4k', input: 0.1, output: 0.2, status: 'Live' },
  { id: 'nvidia/nemotron-3-ultra-550b-a55b', provider: 'NVIDIA', type: 'Text', context: '4k', input: 2.0, output: 5.0, status: 'Live' },
  { id: 'google/gemma-4-31b-it', provider: 'Google', type: 'Text', context: '32k', input: 0.2, output: 0.6, status: 'Live' },

  { id: 'llama-3.3-70b-versatile', provider: 'Groq', type: 'Text', context: '128k', input: 0.59, output: 0.79, status: 'Live' },
  { id: 'llama-3.1-8b-instant', provider: 'Groq', type: 'Text', context: '128k', input: 0.05, output: 0.08, status: 'Live' },
  { id: 'groq/compound', provider: 'Groq', type: 'Reasoning', context: '128k', input: 0.20, output: 0.50, status: 'Live' },
  { id: 'groq/compound-mini', provider: 'Groq', type: 'Reasoning', context: '128k', input: 0.10, output: 0.20, status: 'Live' },
  { id: 'openai/gpt-oss-120b', provider: 'OpenAI (Groq)', type: 'Text', context: '128k', input: 0.90, output: 2.00, status: 'Live' },
  { id: 'openai/gpt-oss-20b', provider: 'OpenAI (Groq)', type: 'Text', context: '128k', input: 0.20, output: 0.40, status: 'Live' },
