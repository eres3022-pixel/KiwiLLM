...
export const footerColumns = [
  ...
  { title: 'Social', links: [{ label: 'Telegram', href: 'https://t.me/kiwillmofficial' }, { label: 'Discord', href: 'https://discord.gg/RCZXtvyByj' }, { label: 'Twitter', href: 'https://x.com/KIWILLM' }, { label: 'GitHub', href: '/github' }] },
]
