...
import { dashboardPlaceholders, topUpPlans, pageLinks } from '../data'
import { dashboardGreeting, barChart, pageHeader } from '../helpers'
        ...
        <div class="dash-hero-right">
          ...
          <a href="#" class="dash-invite-card">
            ...
            <div>
              ...
              <small>Draw for free API credits</small>
            </div>
  ...
  -d '{"model":"llama-3.2-1b","messages":[{"role":"user","content":"hi"}]}'</code></pre>
      ...
      <section class="community-banner">
        ...
        <div class="community-buttons">
          <a href="https://t.me/kiwillmofficial" target="_blank" rel="noopener noreferrer" class="community-btn community-btn-telegram">
